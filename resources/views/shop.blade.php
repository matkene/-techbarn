    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6">
        <div class="banner__pic">
          <img src="assets/img/featured/{{$product->product_image}}" alt="" />
        </div>
      </div>

      <div class="col-lg-6 col-md-6 col-sm-6">
        <div class="banner__pic">
            <form action="{{route('sale')}}" class="form-horizontal" method="POST">
                @csrf
                <input type="hidden" value="{{$product->id}}" name="id">
                <input type="hidden" value="{{$product->new_price}}" name="total_price">
                <input type="hidden" value="{{$product->shipping_fee}}" name="total_shipping_fee">
                <input type="hidden" value="1" name="quantity">

                 <label class="col-md-6 control-label">{{$product->product_name}}</label>
                 <label class="col-md-6 control-label">₦{{$product->new_price}}</label>
                 <label class="col-md-6 control-label">Quantity :  1</label>
                 <label class="col-md-6 control-label">DESCRIPTION</label>
                 <label class="col-md-6 control-label">{{$product->product_description}}</label>
                <button type="submit" class="col-md-6 site-btn">PURCHASE PRODUCT</button>
              </form>
        </div>
      </div>
