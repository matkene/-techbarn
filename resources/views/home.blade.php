  ...
  <div class="container">
    ...
    <div class="row featured__filter">
        ...
        <div class="featured__item">
          <div class="featured__item__pic set-bg" data-setbg="assets/img/featured/{{$item->product_image}}">
            <ul class="featured__item__pic__hover">
              <li><a href="{{route('looked', ['id'=>$item->id])}}"><i class="fa fa-retweet"></i></a></li>
              <li><a href="{{route('wishlist',['id'=>$item->id])}}"><i class="fa fa-heart"></i></a></li>
              <li><a href="{{route('shop',['id'=>$item->id])}}"><i class="fa fa-shopping-cart"></i></a></li>
            </ul>
          </div>
